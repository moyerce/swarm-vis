...
In addition, a particle's color show0s change in data values: blue and red for a decrease and increase, respectively.
...
analyze the tetrahedron-forming swarm. First, we provide background in the domain.
